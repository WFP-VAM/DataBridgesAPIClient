...
class MarketPricesApi:
    ...
    def market_prices_alps_get(
        ...
        price_type_name: Annotated[
            Optional[StrictStr],
            Field(description="Price type: [retail|wholesale|farmgate]"),
        ] = None,
        currency_id: Annotated[
            Optional[StrictInt],
            Field(description="The exact ID of a currency, as found in /Currency/List"),
        ] = None,
        price_flag: Annotated[
            Optional[StrictStr],
            Field(
        ...
        latest_value_only: Annotated[
            Optional[StrictBool], Field(description="[TRUE|FALSE]")
        ] = None,
        page: Annotated[
