...
class CommodityUnitsApi:
    ...
    def commodity_units_conversion_list_get(
        ...
        from_unit_id: Annotated[
            Optional[StrictInt],
            Field(
                description="The exact ID of the original unit of measure of the price of a commodity, as found in /CommodityUnits/List"
            ),
        ] = None,
        to_unit_id: Annotated[
            Optional[StrictInt],
            Field(
                description="The exact ID of the converted unit of measure of the price of a commodity, as found in /CommodityUnits/List"
            ),
        ] = None,
        page: Annotated[
    ...
    def commodity_units_list_get(
        ...
        commodity_unit_name: Annotated[
            Optional[StrictStr],
            Field(
                description="The name, even partial and case insensitive, of a commodity unit"
            ),
        ] = None,
        commodity_unit_id: Annotated[
            Optional[StrictInt], Field(description="The exact ID of a commodity unit")
        ] = None,
        page: Annotated[
            Optional[StrictInt], Field(description="page number for paged results")
        ] = None,
        ...
        """Provides the detailed list of the unit of measure available in DataBridges platform
          ...
          ![Generic badge](https://img.shields.io/badge/Maturity%20Level-Production%20Ready-green)  ![Generic badge](https://img.shields.io/badge/Access_Policy-TEC_Architecture_approval_required-yellow)  ![Generic badge](https://img.shields.io/badge/Data%20Classification-Public-green)  ### This endpoint is restricted, it requires the permission: \"vamdatabridges\\_commodityunits-list\\_get\"      **Data Controller** - Wael ATTIA  **API Integration Pattern** - This endpoint uses [Hey Jude](https://docs.api.wfp.org/providers/#api-patterns) pattern
