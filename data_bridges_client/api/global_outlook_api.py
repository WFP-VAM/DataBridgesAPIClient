...
class GlobalOutlookApi:
    ...
    def global_outlook_global_latest_get(
        ...
        """Return the latest global dataset of number of acutely food insecure (in millions)  based on WFP's Global Outlook.
          ...
          ![Generic badge](https://img.shields.io/badge/Maturity%20Level-Production%20Ready-green)  ![Generic badge](https://img.shields.io/badge/Access_Policy-TEC_Architecture_approval_required-yellow)  ![Generic badge](https://img.shields.io/badge/Data%20Classification-Public-green)  ### This endpoint is restricted, it requires the permission: \"vamdatabridges\\_globaloutlook-globallatest\\_get\"      **Data Controller** - Wael ATTIA  **API Integration Pattern** - This endpoint uses [Hey Jude](https://docs.api.wfp.org/providers/#api-patterns) pattern
    ...
    def global_outlook_regional_latest_get(
        ...
        """Return the latest regional dataset of number of acutely food insecure (in millions)  based on WFP's Global Outlook.
          ...
          ![Generic badge](https://img.shields.io/badge/Maturity%20Level-Production%20Ready-green)  ![Generic badge](https://img.shields.io/badge/Access_Policy-TEC_Architecture_approval_required-yellow)  ![Generic badge](https://img.shields.io/badge/Data%20Classification-Public-green)  ### This endpoint is restricted, it requires the permission: \"vamdatabridges\\_globaloutlook-regionallatest\\_get\"      **Data Controller** - Wael ATTIA  **API Integration Pattern** - This endpoint uses [Hey Jude](https://docs.api.wfp.org/providers/#api-patterns) pattern
