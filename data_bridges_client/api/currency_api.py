...
class CurrencyApi:
    ...
    def currency_list_get(
        ...
        currency_name: Annotated[
            Optional[StrictStr],
            Field(description="Currency 3-letter code, matching with ISO 4217."),
        ] = None,
        currency_id: Annotated[
            Optional[StrictInt],
            Field(
                description="Unique code to identify the currency in internal VAM currencies."
            ),
        ] = None,
        page: Annotated[
    ...
    def currency_usd_indirect_quotation_get(
        ...
        currency_name: Annotated[
            Optional[StrictStr],
            Field(description="the ISO3 code for the currency, based on ISO4217"),
        ] = None,
        page: Annotated[
            Optional[StrictInt], Field(description="Page number for paged results")
        ] = None,
