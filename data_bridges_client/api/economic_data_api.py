...
class EconomicDataApi:
    ...
    def economic_data_indicator_list_get(
        ...
        indicator_name: Annotated[
            Optional[StrictStr], Field(description="Unique indicator name.")
        ] = None,
        iso3: Annotated[
            Optional[StrictStr],
            Field(
                description="The code to identify the country. Must be a ISO-3166 Alpha 3 code."
            ),
        ] = None,
        format: Annotated[
            Optional[StrictStr],
        ...
        """Returns the lists of indicators.
          ...
          ![Generic badge](https://img.shields.io/badge/Maturity%20Level-Production%20Ready-green)  ![Generic badge](https://img.shields.io/badge/Access_Policy-TEC_Architecture_approval_required-yellow)  ![Generic badge](https://img.shields.io/badge/Data%20Classification-Public-green)  ### This endpoint is restricted, it requires the permission: \"vamdatabridges\\_economicdata-indicatorlist\\_get\"  Returns the lists of indicators for which Vulnerability Analysis and Mapping - Economic and Market Analysis Unit has redistribution licensing from Trading Economics. No mandatory parameter.    **Data Controller** - Wael ATTIA  **API Integration Pattern** - This endpoint uses [Hey Jude](https://docs.api.wfp.org/providers/#api-patterns) pattern
    ...
    def economic_data_indicator_name_get(
        ...
        indicator_name: Annotated[
            StrictStr,
            Field(
                description="Name of the indicator as found in /EconomicData/IndicatorList."
            ),
        ],
        page: Annotated[
            Optional[StrictInt], Field(description="Page number for paged results")
        ...
        """Returns the time series of values for different indicators.
          ...
          ![Generic badge](https://img.shields.io/badge/Maturity%20Level-Production%20Ready-green)  ![Generic badge](https://img.shields.io/badge/Access_Policy-TEC_Architecture_approval_required-yellow)  ![Generic badge](https://img.shields.io/badge/Data%20Classification-Public-green)  ### This endpoint is restricted, it requires the permission: \"vamdatabridges\\_economicdata\\_get\"  Indicator name as retrieved from /EconomicData/IndicatorList is mandatory.    **Data Controller** - Wael ATTIA  **API Integration Pattern** - This endpoint uses [Hey Jude](https://docs.api.wfp.org/providers/#api-patterns) pattern
