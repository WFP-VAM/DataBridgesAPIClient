...
class CommoditiesApi:
    ...
    def commodities_list_get(
        ...
        commodity_name: Annotated[
            Optional[StrictStr],
            Field(
                description="The name, even partial and case insensitive, of a commodity"
            ),
        ] = None,
        commodity_id: Annotated[
            Optional[StrictInt], Field(description="The exact ID of a commodity")
        ] = None,
        page: Annotated[
            Optional[StrictInt], Field(description="page number for paged results")
        ] = None,
        ...
        """Provide the detailed list of the commodities available in DataBridges platform
          ...
          ![Generic badge](https://img.shields.io/badge/Maturity%20Level-Production%20Ready-green)  ![Generic badge](https://img.shields.io/badge/Access_Policy-TEC_Architecture_approval_required-yellow)  ![Generic badge](https://img.shields.io/badge/Data%20Classification-Public-green)  ### This endpoint is restricted, it requires the permission: \"vamdatabridges\\_commodities-list\\_get\"  COICOP 2018 codes are returned to hierarchically matching categories based on [UN-Statistical Division codes](https://unstats.un.org/unsd/classifications/Econ/). No mandatory parameter.    **Data Controller** - Wael ATTIA  **API Integration Pattern** - This endpoint uses [Hey Jude](https://docs.api.wfp.org/providers/#api-patterns) pattern
