...
class HungerHotspotApi:
    ...
    def hunger_hotspot_data_get(
        ...
        """Retrieves a paginated list of Hunger Hotspot data.
          ...
          ![Generic badge](https://img.shields.io/badge/Maturity%20Level-Production%20Ready-green)  ![Generic badge](https://img.shields.io/badge/Access_Policy-TEC_Architecture_approval_required-yellow)  ![Generic badge](https://img.shields.io/badge/Data%20Classification-Public-green)  ### This endpoint is restricted, it requires the permission: \"vamdatabridges\\_hungerhotspot-data\\_get\"      **Data Controller** - Wael ATTIA  **API Integration Pattern** - This endpoint uses [Hey Jude](https://docs.api.wfp.org/providers/#api-patterns) pattern
