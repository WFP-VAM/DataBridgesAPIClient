...
class ViewExtendedMonthlyAggregatedPrice(BaseModel):
    ...
    commodity_date_week: Optional[StrictInt] = Field(
        default=None, alias="commodityDateWeek"
    )
    commodity_date_month: Optional[StrictInt] = Field(
        default=None, alias="commodityDateMonth"
    )
    commodity_date_year: Optional[StrictInt] = Field(
        default=None, alias="commodityDateYear"
    )
    ...
    commodity_unit_name: Optional[StrictStr] = Field(
        default=None, alias="commodityUnitName"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # and model_fields_set contains the field
        if (
            self.commodity_date_week is None
            and "commodity_date_week" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.commodity_date_month is None
            and "commodity_date_month" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.commodity_date_year is None
            and "commodity_date_year" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.commodity_price_date is None
            and "commodity_price_date" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.commodity_unit_name is None
            and "commodity_unit_name" in self.model_fields_set
        ):
