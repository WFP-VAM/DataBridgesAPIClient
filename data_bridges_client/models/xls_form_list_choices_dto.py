...
class XlsFormListChoicesDTO(BaseModel):
    """
    XlsFormListChoicesDTO
    """ # noqa: E501
    name: Optional[StrictStr] = None
    choices: Optional[List[XlsFormListChoiceDTO]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "choices"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "choices": [XlsFormListChoiceDTO.from_dict(_item) for _item in obj["choices"]] if obj.get("choices") is not None else None
        })
