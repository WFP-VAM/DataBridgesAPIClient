...
class IpcchAndEquivalentPeaksDTO(BaseModel):
    ...
    regional_bureau_id: Optional[StrictInt] = Field(
        default=None, alias="regionalBureauID"
    )
    regional_bureau_name: Optional[StrictStr] = Field(
    ...
    phase3_population: Optional[StrictInt] = Field(
        default=None, alias="phase3Population"
    )
    phase4_population: Optional[StrictInt] = Field(
        default=None, alias="phase4Population"
    )
    phase5_population: Optional[StrictInt] = Field(
        default=None, alias="phase5Population"
    )
    phase3_plus_population: Optional[StrictInt] = Field(
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if (
            self.regional_bureau_id is None
            and "regional_bureau_id" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.regional_bureau_name is None
            and "regional_bureau_name" in self.model_fields_set
        ):
        ...
        # set to None if reference_year (nullable) is None
        # and model_fields_set contains the field
        if self.reference_year is None and "reference_year" in self.model_fields_set:
            _dict["referenceYear"] = None
