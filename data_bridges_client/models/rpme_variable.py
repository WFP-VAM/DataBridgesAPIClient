...
class RpmeVariable(BaseModel):
    ...
    variable_description: Optional[StrictStr] = Field(
        default=None, alias="variableDescription"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # and model_fields_set contains the field
        if (
            self.variable_description is None
            and "variable_description" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.survey_mode_name is None
            and "survey_mode_name" in self.model_fields_set
        ):
