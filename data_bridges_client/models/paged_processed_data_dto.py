...
class PagedProcessedDataDTO(BaseModel):
    ...
    total_items: Optional[StrictInt] = Field(
        default=None, description="The total number of items", alias="totalItems"
    )
    page: Optional[StrictInt] = Field(default=None, description="The current page")
    scroll_id: Optional[StrictInt] = Field(default=None, alias="scrollId")
    items: Optional[List[MFIProcessedDataDTO]] = Field(
        default=None, description="The list of processed data"
    )
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["totalItems", "page", "scrollId", "items"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "page": obj.get("page"),
                "scrollId": obj.get("scrollId"),
                "items": (
                    [MFIProcessedDataDTO.from_dict(_item) for _item in obj["items"]]
