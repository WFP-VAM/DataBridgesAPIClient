...
class PagedCommodityWeeklyAggregatedPriceListDTO(BaseModel):
    ...
    items: Optional[List[WeeklyAggregatedPrice]] = Field(
        default=None, description="The list of paged items"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "page": obj.get("page"),
                "items": (
                    [WeeklyAggregatedPrice.from_dict(_item) for _item in obj["items"]]
