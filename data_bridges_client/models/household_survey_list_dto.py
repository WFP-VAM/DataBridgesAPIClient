...
class HouseholdSurveyListDTO(BaseModel):
    ...
    survey_id: Optional[StrictInt] = Field(
        default=None, description="The Id of the Survey", alias="surveyID"
    )
    survey_status_id: Optional[StrictInt] = Field(
    ...
    iso3_alpha3: Optional[StrictStr] = Field(
        default=None,
    ...
    original_csv_file: Optional[StrictStr] = Field(
        default=None,
        description="The link to download the original CSV file",
        alias="originalCsvFile",
    )
    base_data: Optional[StrictStr] = Field(
        default=None,
        description="The link to the JSON data reshaped on the base XLSForm",
        alias="baseData",
    )
    survey_attributes: Optional[List[KeyNameDto]] = Field(
        default=None, alias="surveyAttributes"
    )
    organizations: Optional[List[KeyNameDto]] = None
    survey_modality_name: Optional[StrictStr] = Field(
        default=None, alias="surveyModalityName"
    )
    survey_category_name: Optional[StrictStr] = Field(
        default=None, alias="surveyCategoryName"
    )
    survey_sub_category_name: Optional[StrictStr] = Field(
        default=None, alias="surveySubCategoryName"
    )
    survey_phase_name: Optional[StrictStr] = Field(
        default=None, alias="surveyPhaseName"
    )
    survey_visibility: Optional[StrictStr] = Field(
        default=None, alias="surveyVisibility"
    )
    is_continuous_monitoring: Optional[StrictBool] = Field(
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if (
            self.survey_start_date is None
            and "survey_start_date" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.survey_validation_report is None
            and "survey_validation_report" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.survey_original_filename is None
            and "survey_original_filename" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.base_xls_form_name is None
            and "base_xls_form_name" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.original_csv_file is None
            and "original_csv_file" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.survey_attributes is None
            and "survey_attributes" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.survey_modality_name is None
            and "survey_modality_name" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.survey_category_name is None
            and "survey_category_name" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.survey_sub_category_name is None
            and "survey_sub_category_name" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.survey_phase_name is None
            and "survey_phase_name" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.survey_visibility is None
            and "survey_visibility" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "surveyAttributes": [
                    KeyNameDto.from_dict(_item) for _item in obj["surveyAttributes"]
                ]
                if obj.get("surveyAttributes") is not None
                else None,
                "organizations": [
                    KeyNameDto.from_dict(_item) for _item in obj["organizations"]
                ]
