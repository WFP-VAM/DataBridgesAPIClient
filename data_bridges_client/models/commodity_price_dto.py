...
class CommodityPriceDTO(BaseModel):
    ...
    id: Optional[StrictInt] = Field(
        default=None, description="The internal ID of the commodity"
    )
    ...
    commodity_unit_id: Optional[StrictInt] = Field(
    ...
    original_frequency: Optional[StrictStr] = Field(
        default=None, alias="originalFrequency"
    )
    ...
    commodity_price: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, alias="commodityPrice"
    )
    commodity_price_source_name: Optional[StrictStr] = Field(
        default=None, alias="commodityPriceSourceName"
    )
    commodity_price_metadata: Optional[Any] = Field(
        default=None, alias="commodityPriceMetadata"
    )
    commodity_price_date: Optional[datetime] = Field(
        default=None, alias="commodityPriceDate"
    )
    commodity_price_observations: Optional[StrictInt] = Field(
        default=None, alias="commodityPriceObservations"
    )
    commodity_price_date_day: Optional[StrictInt] = Field(
        default=None, alias="commodityPriceDateDay"
    )
    commodity_price_date_week: Optional[StrictInt] = Field(
        default=None, alias="commodityPriceDateWeek"
    )
    commodity_price_date_month: Optional[StrictInt] = Field(
        default=None, alias="commodityPriceDateMonth"
    )
    commodity_price_date_year: Optional[StrictInt] = Field(
        default=None, alias="commodityPriceDateYear"
    )
    commodity_price_insert_date: Optional[datetime] = Field(
        default=None, alias="commodityPriceInsertDate"
    )
    commodity_price_flag: Optional[StrictStr] = Field(
        default=None, alias="commodityPriceFlag"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # and model_fields_set contains the field
        if (
            self.original_frequency is None
            and "original_frequency" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.commodity_price_source_name is None
            and "commodity_price_source_name" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.commodity_price_metadata is None
            and "commodity_price_metadata" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.commodity_price_observations is None
            and "commodity_price_observations" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.commodity_price_date_day is None
            and "commodity_price_date_day" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.commodity_price_date_week is None
            and "commodity_price_date_week" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.commodity_price_date_month is None
            and "commodity_price_date_month" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.commodity_price_insert_date is None
            and "commodity_price_insert_date" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.commodity_price_flag is None
            and "commodity_price_flag" in self.model_fields_set
        ):
