...
class RpmeAssessment(BaseModel):
    ...
    sh_latitude: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, alias="shLatitude"
    )
    sh_longitude: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, alias="shLongitude"
    )
    nb_beneficiaries_interviewed: Optional[StrictInt] = Field(
        default=None, alias="nbBeneficiariesInterviewed"
    )
    ...
    beneficiaries_score_tbu: Optional[StrictBool] = Field(
        default=None, alias="beneficiariesScoreTbu"
    )
    ...
    output_values: Optional[List[RpmeOutputValues]] = Field(
        default=None, alias="outputValues"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # and model_fields_set contains the field
        if (
            self.nb_beneficiaries_interviewed is None
            and "nb_beneficiaries_interviewed" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.ben_sev_cntr_dev is None
            and "ben_sev_cntr_dev" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "outputValues": (
                    [RpmeOutputValues.from_dict(_item) for _item in obj["outputValues"]]
                    if obj.get("outputValues") is not None
                    else None
                ),
            }
        )
