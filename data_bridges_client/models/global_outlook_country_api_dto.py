...
class GlobalOutlookCountryApiDto(BaseModel):
    ...
    country_office_iso3: Optional[StrictStr] = Field(
        default=None, alias="countryOfficeIso3"
    )
    total_value: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, alias="totalValue"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # and model_fields_set contains the field
        if (
            self.country_office_iso3 is None
            and "country_office_iso3" in self.model_fields_set
        ):
