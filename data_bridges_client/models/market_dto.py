...
class MarketDTO(BaseModel):
    ...
    market_id: Optional[StrictInt] = Field(
        default=None, description="The internal ID of the market", alias="marketId"
    )
    market_name: Optional[StrictStr] = Field(
        default=None, description="The name of the market", alias="marketName"
    )
    market_local_name: Optional[StrictStr] = Field(
        default=None,
        description="The local name of the market",
        alias="marketLocalName",
    )
    market_latitude: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="The decimal latitude", alias="marketLatitude"
    )
    market_longitude: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="The decimal longitude", alias="marketLongitude"
    )
    admin1_name: Optional[StrictStr] = Field(
        default=None,
        description="The name of the first level administrative division where the market is placed",
        alias="admin1Name",
    )
    admin1_code: Optional[StrictInt] = Field(
        default=None,
        description="The code of the first level administrative division where the market is placed",
        alias="admin1Code",
    )
    admin2_name: Optional[StrictStr] = Field(
        default=None,
        description="The name of the second level administrative division where the market is placed",
        alias="admin2Name",
    )
    admin2_code: Optional[StrictInt] = Field(
        default=None,
        description="The code of the second level administrative division where the market is placed",
        alias="admin2Code",
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # and model_fields_set contains the field
        if (
            self.market_local_name is None
            and "market_local_name" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.market_longitude is None
            and "market_longitude" in self.model_fields_set
        ):
