...
class XlsFormDTO(BaseModel):
    ...
    xls_form_create_date: Optional[datetime] = Field(
        default=None, alias="xlsFormCreateDate"
    )
    user_name: Optional[StrictStr] = Field(default=None, alias="userName")
    xls_form_source_file: Optional[StrictStr] = Field(
        default=None, alias="xlsFormSourceFile"
    )
    xls_form_is_base_schema: Optional[StrictBool] = Field(
        default=None, alias="xlsFormIsBaseSchema"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # and model_fields_set contains the field
        if (
            self.xls_form_source_file is None
            and "xls_form_source_file" in self.model_fields_set
        ):
