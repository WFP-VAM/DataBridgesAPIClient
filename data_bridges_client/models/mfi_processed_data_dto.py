...
class MFIProcessedDataDTO(BaseModel):
    ...
    market_latitude: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, alias="marketLatitude"
    )
    ...
    output_value: Optional[Union[StrictFloat, StrictInt]] = Field(
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # and model_fields_set contains the field
        if (
            self.traders_sample_size is None
            and "traders_sample_size" in self.model_fields_set
        ):
