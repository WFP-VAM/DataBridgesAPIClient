...
class IpcchBaseDto(BaseModel):
    ...
    population_group_id: Optional[StrictInt] = Field(
        default=None, alias="populationGroupId"
    )
    population_group_name: Optional[StrictStr] = Field(
        default=None, alias="populationGroupName"
    )
    ...
    population_analysed: Optional[StrictInt] = Field(
        default=None, alias="populationAnalysed"
    )
    population_analysed_percentage: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, alias="populationAnalysedPercentage"
    )
    ...
    phase4_plus_population: Optional[StrictInt] = Field(
        default=None, alias="phase4PlusPopulation"
    )
    ...
    phase4_plus_percentage: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, alias="phase4PlusPercentage"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # and model_fields_set contains the field
        if (
            self.population_group_name is None
            and "population_group_name" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.population_analysed is None
            and "population_analysed" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.population_analysed_percentage is None
            and "population_analysed_percentage" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.phase4_plus_population is None
            and "phase4_plus_population" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.phase4_plus_percentage is None
            and "phase4_plus_percentage" in self.model_fields_set
        ):
