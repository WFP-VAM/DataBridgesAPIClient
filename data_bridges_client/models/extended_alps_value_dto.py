...
class ExtendedAlpsValueDto(BaseModel):
    ...
    analysis_value_estimated_price: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, alias="analysisValueEstimatedPrice"
    )
    analysis_value_pewi_value: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, alias="analysisValuePewiValue"
    )
    analysis_value_price_flag: Optional[StrictStr] = Field(
        default=None, alias="analysisValuePriceFlag"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # and model_fields_set contains the field
        if (
            self.analysis_value_price_flag is None
            and "analysis_value_price_flag" in self.model_fields_set
        ):
