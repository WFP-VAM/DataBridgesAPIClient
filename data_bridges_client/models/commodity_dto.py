...
class CommodityDTO(BaseModel):
    ...
    name: Optional[StrictStr] = Field(
        default=None, description="The name of the commodity"
    )
    coicop2018: Optional[StrictStr] = Field(
        default=None, description="The COICOP 2018 definition"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "qualities": [
                    CommodityQualityDTO.from_dict(_item) for _item in obj["qualities"]
                ]
                if obj.get("qualities") is not None
                else None,
                "processing": [
                    CommodityProcessingDTO.from_dict(_item)
                    for _item in obj["processing"]
                ]
                if obj.get("processing") is not None
                else None,
            }
        )
